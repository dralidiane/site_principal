...
import aboutImageWebP from '../assets/logos/about-image.webp';
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 space-y-6 sm:space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4 sm:space-y-6 text-[#1e1e1e]/80 font-body font-light text-sm sm:text-base">
              <p>
                Dedicada à arte da harmonização orofacial,
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-4">
              <div className="text-center p-3 sm:p-4">
                <GraduationCap size={28} className="sm:w-8 sm:h-8 mx-auto mb-2 sm:mb-3 text-[#c8a09b]" strokeWidth={1.5} />
                <p className="text-xs sm:text-sm font-body font-light text-[#1e1e1e]">Formação Especializada</p>
              </div>
              <div className="text-center p-3 sm:p-4">
